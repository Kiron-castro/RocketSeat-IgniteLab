          ...
          <div className="flex-1">
            ...
            {data.lesson.description}
              ...
              <div className="flex items-center gap-4 mt-6">
                ...
                src="http://github.com/kiron-castro.png" 
                alt="" 
                />
              </div>

              <div className="leading-relaxed">
                <strong className="font-bold text-2xl block">Kiron de Castro</strong>
                <span className="text-gray-200 text-sm block">Developer at TecnoCastro</span>
              </div>
          </div>
